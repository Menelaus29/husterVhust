 ...
 * @version 1.0
 */
public class MinigameCounter extends Actor
{
    ...
    public MinigameCounter(String prefix)
    {
    ...
    private void updateImage() {
        ...
        GreenfootImage text = new GreenfootImage(80, 22); // Create an image with a width and height
        text.setFont(new Font("Arial", 20)); // Set the font
        text.setColor(new greenfoot.Color(0, 0, 0)); // Set the text color to black
        text.drawString(prefix + value, 30, 20); // Draw the text onto the image
